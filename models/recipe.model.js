...
let recipes = [
    new Recipe(0, 'Pizza Margherita', [new Item('Pizza crust', 1), new Item('Tomato sauce', 1),
        new Item('Mozzarella', 8), new Item('Plum tomatoes', 2), new Item('Basil', 1)], ['Put everything together',
        'Bake for 14-16 minutes'], 60),
    new Recipe(1, 'Raw chicken', [new Item('Chicken', 1), new Item('Hammer', 1),], [
        "Hit the head's chicken with the hammer", "Skin the chicken", "Serve fresh",], 5)
];
